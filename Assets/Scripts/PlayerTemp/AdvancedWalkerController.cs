	...
	public class AdvancedWalkerController : Controller
	{
		...
		protected virtual Vector3 CalculateMovementDirection()
		{
			...
			else
			{
				...
				_velocity += Vector3.ProjectOnPlane(cameraTransform.right, tr.up).normalized * GetHorizontalMovementInput();
				_velocity += Vector3.ProjectOnPlane(cameraTransform.forward, tr.up).normalized * GetVerticalMovementInput();
			}
		...
		private float GetHorizontalMovementInput()
		{
			...
			return InputManager.Instance.moveDirection.x;
		}
		...
		private float GetVerticalMovementInput()
		{
			...
			return InputManager.Instance.moveDirection.y;
		}

		private bool IsJumpKeyPressed()
		{
			//	return Input.GetKey(jumpKey);
			return InputManager.Instance.jumpButton;
		}
	}
}
